    ...
    try{
        ...
        if(resultinfo){
              ...
              const messageData = {
                  ...
                  type: 'text',
                  message: `আপনার সন্তানের পড়াশোনার মনোযোগ বৃদ্ধির জন্য আমরা ${date} ষাণ্মাসিক  মূল্যায়ন পরীক্ষার আয়োজন করি | আজ পরীক্ষার ফলাফল দেয়া  হয়েছে | আপনার সন্তানের ${subject_name} এ প্রাপ্ত নম্বর ${subject_number} পরীক্ষার নম্বর ${exam_number}|আপনার সন্তানের প্রতি আপনাকে আরো দায়িত্ববান হওয়ার জন্য বিনীত অনুরোধ জানাচ্ছি |
                  -অল কেয়ার একাডেমী`,
